...
public class RegressionTests
{
    ...
    {
        var result = new MovieManager.Core.Interfaces.ImportResult();
    ...
    {
        var result = new MovieManager.Core.Interfaces.MovieSearchResult
        {
            Title = "测试",
            Year = 2020,
            Source = "douban",
    ...
    {
        var data = new MovieManager.Core.Interfaces.StatisticsData
        {
            TotalMovies = 10,
            Watched = 5,
